	...
	<table border="1" width="500">
		...
		<tr>
			<td colspan="4" align="center">
				...
				<input type="button" value="수정" onclick="location.href='modify.other?bno=${vo.bno}&writer=${vo.writer }';">&nbsp;&nbsp;
				<input type="button" value="삭제" onclick="location.href='delete.other?bno=${vo.bno}&writer=${vo.writer }';">&nbsp;&nbsp;
				</c:if>
			</td>
		</tr>
	</table>
