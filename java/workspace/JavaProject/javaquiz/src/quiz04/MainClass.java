...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("원의 넓이 : " + cal.circle(10));
		cal.add(10);
		cal.add(20);
		System.out.println("누적 값 : "+cal.result);
	
		
		Computer com = new Computer();
		System.out.println("정사각형의 넓이 : " + com.rect(3));
		System.out.println("직사각형의 넓이 : " + com.rect(3, 3));
		System.out.println("직육면체의 부피 : " + com.rect(3, 3, 3));
		System.out.println("원의 넓이 : " + com.circle(3));
